...
<form method="post" action="">
	...
	<div class="row" style="margin-bottom:5px;">
		...
		<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12">
			<input type="text" name="from" value="<?php if($post==1){echo $ip;}?>">
		</div>
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
			Page Name
		</div>
		<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
			<select name="page">
				...
				<option value="Booking">Passenger</option>
	...
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
			<span style="font-weight: 600;font-size:25px;">Total clicks = <?php if($post==1){echo $count;}else{echo 0;}?></span>
		</div>
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
