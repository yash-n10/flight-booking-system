        ...
        <div class="row">
           <!--  <div class="col-lg-4 mb-lg-0 mb-3">
            ...
            <div class="col-12">
                <div class="card p-3">
                        <?php 
                        $data=$this->session->userdata('flight_search');
                    ...
                    <div class="card-body border p-0">
                        <p>
                            <a class=" btn-primary p-2 w-100 h-100 d-flex align-items-center justify-content-between"
                                data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="true"
                                aria-controls="collapseExample" style="font-size:larger;text-decoration:none;color:black">
                        ...
                        <div class="collapse show p-3 pt-0" id="collapseExample">
                            <div class="row">
                                <div class="col-lg-5 mb-lg-0 mb-3">
                                    ...
                                    <span class="fw-bold">Price:</span> <span
                                    class="c-green"><b>:$<?php echo $data
                                    ['data'][$flight_id]['price']
                                    ['total'];?></b></span> </p>
